...
- (void)like{
    self.itemSecond.image = [self reSizeImage:[UIImage imageNamed:@"liked.jpg"] toSize:CGSizeMake(40, 40)];
...
- (void)unLike{
    self.itemSecond.image = [self reSizeImage:[UIImage imageNamed:@"like.jpg"] toSize:CGSizeMake(40, 40)];
...
- (void)star{
    self.itemThird.image = [self reSizeImage:[UIImage imageNamed:@"stared.jpg"] toSize:CGSizeMake(40, 40)];
    self.itemThird.action = @selector(unStar);
    [MBProgressHUDTool showMessage:@"收藏成功"];
}

- (void)unStar{
    self.itemThird.image = [self reSizeImage:[UIImage imageNamed:@"star.jpg"] toSize:CGSizeMake(40, 40)];
